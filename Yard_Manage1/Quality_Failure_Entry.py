...
# Form implementation generated from reading ui file 'Quality_failure_Entry.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.vessel_label)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.vessel_comboBox)
        self.SOC_Label = QtWidgets.QLabel(Dialog)
        self.SOC_Label.setObjectName("SOC_Label")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.SOC_Label)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.SOC_comboBox)
        self.Defect_Label = QtWidgets.QLabel(Dialog)
        self.Defect_Label.setObjectName("Defect_Label")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.Defect_Label)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.defecttype_comboBox)
        self.Weldtype_labe = QtWidgets.QLabel(Dialog)
        self.Weldtype_labe.setObjectName("Weldtype_labe")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.Weldtype_labe)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.wledtype_comboBox)
        self.location_label = QtWidgets.QLabel(Dialog)
        self.location_label.setObjectName("location_label")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.location_label)
        self.location_lineEdit = QtWidgets.QLineEdit(Dialog)
        self.location_lineEdit.setObjectName("location_lineEdit")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.location_lineEdit)
        ...
        self.gridLayout.addWidget(self.save_pushButton, 0, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Add New Quality Failure"))
